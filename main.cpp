...
void LoadAllTextures()
{
	...
	TextureCar = loadBMP2Texture("texture/brickWall.bmp");
}
...
void drawCar(void)
{
	...
	glm::mat4 scale_M = glm::scale(glm::mat4(1.0f), glm::vec3(scale_fact));
	glm::mat4 rot_M = glm::rotate(glm::mat4(1.0f), glm::radians(car_innRot_Degree), glm::vec3(0, 1, 0));
	glm::mat4 trans_M = glm::translate(glm::mat4(1.0f), glm::vec3(8.0f, 8.0f, 8.0f));
	glm::mat4 Model = trans_M * rot_M * scale_M;
